            ...
            <div className="p-2">
              ...
              {authOptions.map((option) => (
                ...
                >
                  ...
                  <span className="font-medium">Continue with {option.name}</span>
                </button>
              ))}
            </div>
          </motion.div>
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 bg-dark/80 backdrop-blur border-b border-dark/60">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-3">
        <div className="text-accent font-bold text-2xl tracking-tight">Ethos</div>
...
function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <p className="max-w-xl mx-auto text-zinc-100 text-lg md:text-2xl mb-8">Create goals, Believe in Yourself and Earn Rewards.</p>
        ...
        {challenges.map((ch, i) => (
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              ...
              />
              <span className="text-zinc-100 font-medium text-sm">{ch.user.name}</span>
            </div>
...
function CallToAction() {
  ...
  return (
    <section className="bg-primary text-dark py-20 px-4 text-center">
      ...
      <p className="text-lg md:text-xl mb-8">Join Ethos and turn challenges into wins.</p>
      {account ? (
...
function Footer() {
  return (
    <footer className="bg-black text-gray-100 text-center text-sm py-6">
      Built with <span className="text-green-400">💙</span> by Ethos. All rights reserved.
    </footer>
  );
}
